...
Next priorities are active-session visibility, settings/permission management,
and broader iframe/shadow-DOM/download fixtures. Keep production host permissions
optional.
